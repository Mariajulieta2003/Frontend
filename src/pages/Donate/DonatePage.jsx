...
import { apiCreateDonation } from "../../api/donations.js";
...
export default function DonarPage() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setErrorMsg(
        err.message ||
          "No pudimos registrar la donación. Intentá nuevamente."
      );
    } finally {
      setLoading(false);
    }
    ...
    <div className="dv-wrap">
      ...
      <section className="dv-hero">
        <div>
          ...
          <p>
            Cada aporte financia castraciones, alimento y cuidados veterinarios a rescates.
          </p>
        ...
        <div className="dv-card">
          ...
          {!sent ? (
            <form onSubmit={submit}>
              ...
              {errorMsg && (
                <p className="dv-error">{errorMsg}</p>
              )}
            ...
            <div className="dv-ok">
              ...
              Registramos tu donación correctamente.
            </div>
          )}
